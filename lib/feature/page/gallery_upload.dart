...
part '../controller/gallery_upload.dart';
part '../view/gallery_upload.dart';
part '../widget/gallery_upload/filled_button.dart';
part '../widget/gallery_upload/image_area.dart';
part '../widget/gallery_upload/upload_button.dart';
