...
part '../controller/receipt_proccess_controller.dart';
part '../view/receipt_process_view.dart';
part '../widget/receipt_process/recpro_filled_button.dart';
part '../widget/receipt_process/recpro_list.dart';
