...
final class ThemeColors {
  ...
  static const Color _surfaceLight = Color(0xffF7F6E5);
  static const Color _onSurfaceLight = Color(0xff1A1C1E);
  static const Color _surfaceContainerHighLight = Color(0xffEDECDB);
  ...
  static const Color _surfaceDark = Color(0xff2C2C2C);
  static const Color _onSurfaceDark = Color(0xffF7F6E5);
  static const Color _surfaceContainerHighDark = Color(0xff3D3D3D);
